...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        joined_path = os.path.join(base, "prt_data",'GlandP_data',"glandpacking.png")
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "gland packing", None))
