...
class Ui_Dialog(object):
    ...
    def create(self): 
         ...
         move_target = None
         for o in new_objs:
             if "inlet"  in o.Label or "inlet"  in o.Name:
                 move_target = o
                 break
             elif "outlet"  in o.Label or "outlet"  in o.Name:
                 move_target = o
                 break
             elif "chute"  in o.Label or "chute"  in o.Name:
                 move_target = o
                 break
             elif "chute3"  in o.Label or "chute3"  in o.Name:
                 move_target = o
                 break
