...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox_type.setGeometry(QtCore.QRect(100, 34, 170, 20))
        ...
        self.standard.setStyleSheet("color: black;")
        ...
        self.dia.setStyleSheet("color: black;")
        self.comboBox_dia = QtGui.QComboBox(Dialog)
        self.comboBox_dia.setGeometry(QtCore.QRect(100, 86, 70, 20))
        ...
        self.fdia.setStyleSheet("color: black;")
        ...
        self.kubisita.setStyleSheet("color: black;")
        ...
        self.nejibu.setStyleSheet("color: black;")
        ...
        self.checkboxf.setStyleSheet("color: black;")
        #checkboxねじ表示
