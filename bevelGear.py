...
class Ui_Dialog(object):
    ...
    def update(self):
        ...
        mySht.set('pcd1',str(pcd1))
        mySht.set('pcd2',str(pcd2))
        mySht.set('delta1',str(delta1))
...
#
        ...
        mySht.set('sita_a',str(sita_a1))

        mySht.set('delta_a1',str(delta_a1))
        mySht.set('delta_a2',str(delta_a2))
        mySht.set('delta_f1',str(delta_f1))
        mySht.set('delta_f2',str(delta_f2))
        mySht.set('da1',str(da1))
        mySht.set('da2',str(da2))
        mySht.set('x1',str(x1))
        mySht.set('x2',str(x2))
        mySht.set('xb1',str(xb1))
        mySht.set('xb2',str(xb2))
        mySht.set('di1',str(di1))
        mySht.set('di2',str(di2))
        mySht.set('dia1',dia1)
        mySht.set('dia2',dia2)
        ...
        mySht.set('xc1',str(xc1))
        mySht.set('xc2',str(xc2))
        #歯車位置
        pL11=x1-xb1
        pL21=R/math.cos(delta1/57.3)
        pL12=x2-xb2
        pL22=R/math.cos(delta2/57.3)
        mySht.set('pL11',str(pL11))
        mySht.set('pL12',str(pL12))
        mySht.set('pL21',str(pL21))
        mySht.set('pL22',str(pL22))
        #内端歯先からボス端まで
        xd1=xc1-pL11
        xd2=xc2-pL12
        mySht.set('xd1',str(xd1))
        mySht.set('xd2',str(xd2))
        #外端歯先円からボス端まで
        xe1=xc1-x1
        xe2=xc2-x2
        mySht.set('xe1',str(xe1))
        mySht.set('xe2',str(xe2))
