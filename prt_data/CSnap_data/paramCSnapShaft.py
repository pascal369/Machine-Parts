...
#      D,   dia3,   thick_t0,    eidth_b,    dia4,     dia0,    length_a,     length_a1,    length_c
CDim={
...
class CSnapShaft:
    def __init__(self, obj):
        ...
        joined_path = os.path.join(base, 'CSnap_data',fname)  
        try:
    ...
    def execute(self, obj):
        #'''
        App.ActiveDocument.Spreadsheet.set('B2',dia)
