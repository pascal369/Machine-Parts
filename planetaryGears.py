...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton.setGeometry(QtCore.QRect(50, 285, 60, 22))
        #更新
    ...
    def spinMove(self):
         ...
         try:
             ...
             sun.Placement.Rotation=App.Rotation(App.Vector(0,1,0),r1*(1+za/zc))
             ...
             planetary001.Placement.Rotation=App.Rotation(App.Vector(0,1,0),-r1*(za/zb))
             planetary002.Placement.Rotation=App.Rotation(App.Vector(0,1,0),-r1*(za/zb))
             planetary003.Placement.Rotation=App.Rotation(App.Vector(0,1,0),-r1*(za/zb))
