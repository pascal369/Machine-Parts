...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "tension coil spring", None))
    ...
    def create(self): 
         ...
         move_target = None
         for o in new_objs:
             if "Spring_tension"  in o.Label or "Spring_tension"  in o.Name:
                 move_target = o
                 break
