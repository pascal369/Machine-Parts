...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(280, 460)
        Dialog.move(1000, 0)
        #shape type
        self.shape = QtGui.QLabel(Dialog)
        ...
        #screw dia
        self.screw_dia = QtGui.QLabel(Dialog)
        ...
        #dim D
        self.lbl_D = QtGui.QLabel(Dialog)
        ...
        #dim L
        self.lbl_L = QtGui.QLabel(Dialog)
        ...
        #dim L1
        self.lbl_L1 = QtGui.QLabel(Dialog)
        ...
        #dim L2
        self.lbl_L2 = QtGui.QLabel(Dialog)
        ...
        #dim L3
        self.lbl_L3 = QtGui.QLabel(Dialog)
        ...
        #dim d0
        self.lbl_d0 = QtGui.QLabel(Dialog)
        ...
        self.lbl_c = QtGui.QLabel(Dialog)
        ...
        #dim m
        self.lbl_m = QtGui.QLabel(Dialog)
        self.lbl_m.setGeometry(QtCore.QRect(30, 175, 50, 12))
        ...
        #dim n
        self.lbl_n = QtGui.QLabel(Dialog)
        self.lbl_n.setGeometry(QtCore.QRect(155, 175, 60, 12))
        ...
        #key_size
        self.lbl_key = QtGui.QLabel(Dialog)
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "WireRope", None))
    ...
    def on_create(self):
        #return
        try:
            label=self.combo_shape.currentText()
        ...
        if key=='00_basic':
            ...
            #obj.addProperty("App::Propertyfloat", "gr0",'shaft').gr0=gr0
